...
public class Solution
{
    ...
    {
        Singleton trySingleton = Singleton.getInstance();
        Singleton trySingleton2 = Singleton.getInstance();
        System.out.println(trySingleton);
        System.out.println(trySingleton2);
    }
}
