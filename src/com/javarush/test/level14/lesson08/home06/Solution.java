...
8.2 вывести на экран movie.getClass().getSimpleName()
        */
        ...
        while (true){
            key = reader.readLine();
            if (key.equals("cartoon")) movie = MovieFactory.getMovie(key);
            else if (key.equals("triller")) movie = MovieFactory.getMovie(key);
            else if (key.equals("soapOpera")) movie = MovieFactory.getMovie(key);
            else break;
