...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer, Contact{
        ...
        public String getPhoneNumber() {
            String s = String.format("%010d", id.getPhoneNumber());
            return String.format("+%d(%s)%s-%s-%s", id.getCountryPhoneCode(), s.substring(0,3), s.substring(3,6), s.substring(6,8), s.substring(8));
        }
